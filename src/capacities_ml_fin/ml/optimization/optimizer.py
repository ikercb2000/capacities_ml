...
# modules
from capacities_ml_fin.ml.optimization.problem import Problem, CvxpyOptimizationProblem, OptimizationProblem
from capacities_ml_fin.ml.optimization.result import OptimizationResult
from capacities_ml_fin.ml.optimization.enums import Solver
from capacities_ml_fin.ml.optimization.objectives import to_cvxpy
...
class Optimizer:
    ...
    def _create_backend(self) -> OptimizerBackend[Any]:
        ...
        if self.solver is Solver.PYMOO:
            from capacities_ml_fin.ml.optimization.backends.to_pymoo import PymooGeneticOptimizer

            return PymooGeneticOptimizer(**self.solver_options)
        if self.solver is Solver.CVXPY:
            from capacities_ml_fin.ml.optimization.backends.to_cvxpy import CvxpyOptimizer
